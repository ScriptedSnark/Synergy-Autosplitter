...
// CREDITS:
// - 2838 for entity list functions
...
{
    print("=========+++=========");
    print("SYNERGY AUTOSPLITTER VERSION " + vars.aslVersion + " by 2838, SmileyAG and ScriptedSnark");
    print("=========+++=========");
...
#region SIGSCANNING
    ...
    var sig_serverState = new SigScanTarget(22, 
        "83 F8 01",                // cmp     eax, 1
    ...
    var sig_mapName = new SigScanTarget(13, 
    ...
    sig_serverState.OnFound = (proc, scanner, ptr) => proc.ReadPointer(ptr, out ptr) ? ptr : IntPtr.Zero;
    sig_mapName.OnFound = (proc, scanner, ptr) => proc.ReadPointer(ptr, out ptr) ? ptr : IntPtr.Zero;
...
split
{
    return (vars.hostState.Current == 3 && vars.hostState.Changed && !vars.startmaps.Contains(vars.mapName.Current));
}
